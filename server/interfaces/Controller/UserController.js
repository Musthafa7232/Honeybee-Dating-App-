export const userDetails =(createNewUser,createJwtToken,userModel,createUserToken)=> async (req, res) => {
  try {
...
export const verifyOtp =(VerifyPhoneOtp,checkOtp,userModel,findUserWithPhone,createJwtToken,createUserToken)=> async (req, res) => {
...
export const userData =(VerifyJwtToken,verifyUserToken,findUserWithId,userModel)=> async (req, res) => {
  try {
...
export const googleData =(userModel,findUserWithEmail,getGoogleOauthToken,getGoogleUser)=> async (req, res) => {
  try {
...
export const googleLogin = (findUserWithEmail,userModel,createUserToken,createJwtToken)=>async (req, res) => {
  try {
